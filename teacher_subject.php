                ...
                <div class="hero-unit-3">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        ...
                        <tbody>
                            ...
                            while($teacher_row = mysql_fetch_array($teacher_subject_query)){                            $subject_id = $teacher_row['subject_id'];

                            $query = mysql_query("select * from subject where subject_id = '$subject_id'") or die(mysql_error());
                            while ($row = mysql_fetch_array($query)) {
                                $ts_id = $row['subject_id'];
                                ?>
                                   <!-- script -->
                            ...
                            <!-- end script -->
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td width="50">
                                        <a rel="tooltip"  title="Delete Subject" id="d<?php echo $subject_id; ?>" href="#id<?php echo $ts_id; ?>" role="button"  data-toggle="modal" class="btn btn-danger"><i class="icon-trash icon-large"></i>&nbsp;</a>

                                    </td>
                                    <!-- user delete modal -->
                            <div id="id<?php echo $ts_id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="delete_teacher_subject.php<?php echo '?id=' . $ts_id; ?>" class="btn btn-danger"><i class="icon-trash icon-large"></i>&nbsp;Delete</a>
                                </div>
                            </div>
                            <!-- end delete modal -->
